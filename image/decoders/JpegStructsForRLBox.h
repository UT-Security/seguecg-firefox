...
#define sandbox_fields_reflection_jpeg_class_jpeg_memory_mgr(f, g, ...) \
  f(void *(*)(j_common_ptr, int, size_t), alloc_small, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(void *(*)(j_common_ptr, int, size_t), alloc_large, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(JSAMPARRAY (*)(j_common_ptr, int, JDIMENSION, JDIMENSION), alloc_sarray, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(JBLOCKARRAY (*)(j_common_ptr, int, JDIMENSION, JDIMENSION), alloc_barray, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(jvirt_sarray_ptr (*)(j_common_ptr, int, boolean, JDIMENSION, JDIMENSION, JDIMENSION), request_virt_sarray, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(jvirt_barray_ptr (*)(j_common_ptr, int, boolean, JDIMENSION, JDIMENSION, JDIMENSION), request_virt_barray, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(void (*)(j_common_ptr), realize_virt_arrays, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(JSAMPARRAY (*)(j_common_ptr, jvirt_sarray_ptr, JDIMENSION, JDIMENSION, boolean), access_virt_sarray, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(JBLOCKARRAY (*)(j_common_ptr, jvirt_barray_ptr, JDIMENSION, JDIMENSION, boolean), access_virt_barray, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(void (*)(j_common_ptr, int), free_pool, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(void (*)(j_common_ptr), self_destruct, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(long, max_memory_to_use, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(long, max_alloc_chunk, FIELD_NORMAL, ##__VA_ARGS__) g()
...
#define sandbox_fields_reflection_jpeg_class_jpeg_compress_struct(f, g, ...) \
  ...
  f(UINT8 [16], arith_dc_L, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(UINT8 [16], arith_dc_U, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(UINT8 [16], arith_ac_K, FIELD_NORMAL, ##__VA_ARGS__) g() \
...
#define sandbox_fields_reflection_jpeg_class_jpeg_destination_mgr(f, g, ...) \
  f(JOCTET *, next_output_byte, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(unsigned long, free_in_buffer, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(void (*)(j_compress_ptr), init_destination, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(boolean (*)(j_compress_ptr), empty_output_buffer, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(void (*)(j_compress_ptr), term_destination, FIELD_NORMAL, ##__VA_ARGS__) g()
...
#define sandbox_fields_reflection_jpeg_class_jpeg_decompress_struct(f, g, ...) \
  ...
  f(int, buffered_image, FIELD_FREEZABLE, ##__VA_ARGS__) g() \
  f(int, raw_data_out, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(J_DCT_METHOD, dct_method, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(int, do_fancy_upsampling, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(int, do_block_smoothing, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(int, quantize_colors, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(J_DITHER_MODE, dither_mode, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(int, two_pass_quantize, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(int, desired_number_of_colors, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(int, enable_1pass_quant, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(int, enable_external_quant, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(int, enable_2pass_quant, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(unsigned int, output_width, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(unsigned int, output_height, FIELD_NORMAL, ##__VA_ARGS__) g() \
  ...
  f(JSAMPROW *, colormap, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(unsigned int, output_scanline, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(int, input_scan_number, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(unsigned int, input_iMCU_row, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(int, output_scan_number, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(unsigned int, output_iMCU_row, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(int (*)[64], coef_bits, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(JQUANT_TBL *[4], quant_tbl_ptrs, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(JHUFF_TBL *[4], dc_huff_tbl_ptrs, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(JHUFF_TBL *[4], ac_huff_tbl_ptrs, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(int, data_precision, FIELD_NORMAL, ##__VA_ARGS__) g() \
  ...
  f(UINT8 [16], arith_ac_K, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(unsigned int, restart_interval, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(int, saw_JFIF_marker, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(unsigned char, JFIF_major_version, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(unsigned char, JFIF_minor_version, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(unsigned char, density_unit, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(unsigned short, X_density, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(unsigned short, Y_density, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(int, saw_Adobe_marker, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(unsigned char, Adobe_transform, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(int, CCIR601_sampling, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(struct jpeg_marker_struct *, marker_list, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(int, max_h_samp_factor, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(int, max_v_samp_factor, FIELD_NORMAL, ##__VA_ARGS__) g() \
...
#define sandbox_fields_reflection_jpeg_class_jpeg_source_mgr(f, g, ...) \
  f(const JOCTET *, next_input_byte, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(unsigned long, bytes_in_buffer, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(void (*)(j_decompress_ptr), init_source, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(boolean (*)(j_decompress_ptr), fill_input_buffer, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(void (*)(j_decompress_ptr, long), skip_input_data, FIELD_NORMAL, ##__VA_ARGS__) g() \
...
#define sandbox_fields_reflection_jpeg_class_jpeg_marker_struct(f, g, ...) \
  ...
  f(unsigned int, original_length, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(unsigned int, data_length, FIELD_NORMAL, ##__VA_ARGS__) g() \
  f(JOCTET *, data, FIELD_NORMAL, ##__VA_ARGS__) g()

#define sandbox_fields_reflection_jpeg_allClasses(f, ...) \
  f(jpeg_common_struct, jpeg, ##__VA_ARGS__) \
  f(jpeg_compress_struct, jpeg, ##__VA_ARGS__) \
  f(jpeg_decompress_struct, jpeg, ##__VA_ARGS__) \
  f(jpeg_destination_mgr, jpeg, ##__VA_ARGS__) \
